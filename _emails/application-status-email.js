...
const applicationStatusEmail = async (email, fullName, statusMessage, ) => {
  const mailOptions = {
    from: `"JobSphere Team" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: "Application Status Update - JobSphere",
    html: `
          ...
          <tr>
            <td style="padding:30px; color:#333333;">
              ...
              <p style="font-size:16px; line-height:1.6;">
                We wanted to update you on the status of your job application:
              </p>
              <div style="margin:20px 0; padding:15px; background-color:#fdf6e3; border-left:5px solid #FFD700; border-radius:6px;">
                <p style="margin:0; font-size:16px; color:#001f3f; font-weight:bold;">
                  ${statusMessage}
                </p>
              </div>
