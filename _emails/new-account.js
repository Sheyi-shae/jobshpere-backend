...
const newAccountEmail = async (email, password, companyName,ctaLink) => {
  const mailOptions = {
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" 
          ...
          <tr>
            <td style="padding:30px; color:#333333;">
              <h2 style="color:#001f3f; margin-top:0;">Hello ,</h2>
              <p style="font-size:16px; line-height:1.6;">
                A new account has been created for you in ${companyName}
              </p>
